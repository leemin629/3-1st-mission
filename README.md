...
전체 기간 기준 월별 상대수준 지수를 보면, 10월이 높은 수준을 보이고 2월은 낮은 수준을 나타내어 전국 관광의 월별 변동 패턴이 확인된다.
...
### 7.4 시기별 월별 변동 패턴 비교 예시

#### 전체방문자수
![시기별 비교_전체방문자수](output/seasonality/compare_periods_전체방문자수.png)

#### 관광총소비
![시기별 비교_관광총소비](output/seasonality/compare_periods_관광총소비_천원.png)
---
